...
define("pilasbloques/tests/acceptance/acercade-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "ember-cli-page-object"], function (_asyncToGenerator2, _qunit, _emberQunit, _emberCliPageObject) {
  "use strict";
  ...
  (0, _qunit.module)('Acceptance | acercade', function (hooks) {
    ...
    (0, _qunit.test)('visiting /acercade',
    /*#__PURE__*/
    function () {
...
define("pilasbloques/tests/acceptance/desafios-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "ember-cli-mirage/test-support/setup-mirage", "ember-cli-page-object"], function (_asyncToGenerator2, _qunit, _emberQunit, _setupMirage, _emberCliPageObject) {
  "use strict";

  var page = (0, _emberCliPageObject.create)({
    cantidadDeDesafiosDisponibles: (0, _emberCliPageObject.count)('.ember-view .desafio .desafio-img')
  });
  var page1 = (0, _emberCliPageObject.create)({
    visit: (0, _emberCliPageObject.visitable)('/libros/1')
  });
  var page2 = (0, _emberCliPageObject.create)({
  ...
  (0, _qunit.module)('Acceptance | desafios', function (hooks) {
    ...
    (0, _qunit.test)('La cantidad de desafíos que se muestra en la pagina 1 es correcta',
    /*#__PURE__*/
    function () {
      var _ref = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(assert) {
        var cantidadDesafiosEsperada;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                cantidadDesafiosEsperada = 55;
                _context.next = 3;
                return page1.visit();
    ...
    (0, _qunit.test)('La cantidad de desafíos que se muestra en la pagina 2 es correcta',
    /*#__PURE__*/
    function () {
...
define("pilasbloques/tests/acceptance/principal-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "ember-cli-page-object", "ember-cli-mirage/test-support/setup-mirage"], function (_asyncToGenerator2, _qunit, _emberQunit, _emberCliPageObject, _setupMirage) {
  "use strict";
...
define("pilasbloques/tests/acceptance/puede-ingresar-en-actividades-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "@ember/test-helpers", "qunit", "ember-qunit", "ember-cli-mirage/test-support/setup-mirage"], function (_asyncToGenerator2, _testHelpers, _qunit, _emberQunit, _setupMirage) {
  "use strict";
  ...
  (0, _qunit.module)('Acceptance | puede ingresar en actividades', function (hooks) {
    ...
    function testSePuedeVisitar(nombreDesafio, tituloEsperado) {
      (0, _qunit.test)("Se puede visitar ".concat(nombreDesafio),
      /*#__PURE__*/
      function () {
        var _ref = (0, _asyncToGenerator2.default)(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee(assert) {
          var tituloVisibleEnPantalla;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.prev = 0;
                  _context.next = 3;
                  return (0, _testHelpers.visit)("/desafios/".concat(nombreDesafio));
                ...
                case 9:
                  tituloVisibleEnPantalla = $(".contenedor-panel-ayuda h4").text();
...
define("pilasbloques/tests/helpers/actividadTest", ["exports", "qunit", "ember-qunit", "ember-cli-mirage/test-support/setup-mirage", "jquery"], function (_exports, _qunit, _emberQunit, _setupMirage, _jquery) {
  ...
  function moduloActividad(nombre, runActivityTests) {
    (0, _qunit.module)("Integration | Actividad | ".concat(nombre), function (hooks) {
  ...
  function validarCantidadDeActores(actoresEsperadosPorEtiqueta, assert, pilas) {
    $.each(actoresEsperadosPorEtiqueta, function (etiqueta, cantidadEsperada) {
      var mensaje = "Hay ".concat(cantidadEsperada, " actores con la etiqueta ").concat(etiqueta, ".");
  ...
  function validarOpciones(opciones) {
    var listaDeOpciones = Object.keys(opciones);
    var opcionesValidas = ['solucion', 'descripcionAdicional', 'errorEsperado', 'resuelveDesafio', 'cantidadDeActoresAlComenzar', 'cantidadDeActoresAlTerminar', 'fps', 'skip'];

    function esOpcionInvalida(opcion) {
      return opcionesValidas.indexOf(opcion) === -1;
    }

    var opcionesInvalidas = $.grep(listaDeOpciones, esOpcionInvalida);
    $.map(opcionesInvalidas, function (opcionInvalida) {
      var error = "La opcion enviada al test (".concat(opcionInvalida, ") es inv\xE1lida.");
      throw new Error(error);
    });

    if (opciones.errorEsperado && opciones.cantidadDeActoresAlTerminar) {
      var error = "Es inv\xE1lido escribir un test que incluya un errorEsperado y conteo de actores al terminar.";
      throw new Error(error);
    }
  ...
  function actividadTest(nombre, opciones) {
    ...
    var descripcion = opciones.descripcionAdicional || 'Se puede resolver';
    (opciones.skip ? _qunit.skip : _qunit.test)(descripcion, function (assert) {
      var _this = this;

      var store = this.owner.lookup('service:store');
      var pilas = this.owner.lookup('service:pilas'); //let actividades = this.owner.lookup('service:actividades');

      return new Promise(function (success) {
        Ember.run(function () {
          // Simula el model hook del router desafío.
          store.findAll("desafio").then(function (data) {
            ...
            var model = data.findBy('nombre', nombre);
            ...
            _this.set('pilas', pilas); // Carga la solución en base64, el formato que espera el componente.


            _this.set('solucion', window.btoa(opciones.solucion)); // Captura el evento de inicialización de pilas:


            _this.set('onReady', function () {
            ...
            pilas.on("errorDeActividad", function (motivoDelError) {
              var errorEsperado = opciones.errorEsperado;
            ...
            _this.set('onTerminoEjecucion', function () {
...
define("pilasbloques/tests/helpers/createPilasTest", ["exports"], function (_exports) {
  ...
  function createPilasTest(context, escena, callback) {
    ...
    return new Promise(function (resolve) {
      var pilasService = context.owner.lookup('service:pilas');
...
define("pilasbloques/tests/helpers/ejerciciosPilasTest", ["exports", "qunit", "ember-qunit", "ember-cli-mirage/test-support/setup-mirage"], function (_exports, _qunit, _emberQunit, _setupMirage) {
  ...
  function moduloEjerciciosPilas(nombre, runExerciseTests) {
    (0, _qunit.module)("Integration | EjerciciosPilas | ".concat(nombre), function (hooks) {
      (0, _emberQunit.setupRenderingTest)(hooks);
      (0, _setupMirage.default)(hooks);
      runExerciseTests();
    });
  ...
  ComportamientoDecorator.prototype = {
    iniciar: function iniciar(receptor) {
...
define("pilasbloques/tests/helpers/mocks", ["exports", "sinon"], function (_exports, _sinon) {
  ...
  var interpreterFactoryMock = Ember.Service.extend({
    crearInterprete: function crearInterprete() {
  ...
  var blocklyWorkspaceMock = function blocklyWorkspaceMock() {
...
define("pilasbloques/tests/helpers/utils", ["exports"], function (_exports) {
  ...
  function findBlockByTypeIn(rootBlock, type) {
    ...
    return rootBlock.getChildren().map(function (b) {
      return findBlockByTypeIn(b, type);
    }).find(function (b) {
      return b != null;
    });
  } ////// ASSERT //////
...
define("pilasbloques/tests/integration/components/modal-ayuda-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/modal-title-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-acerca-de-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-blockly-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers", "pilasbloques/tests/helpers/mocks"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers, _mocks) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | pilas blockly', function (hooks) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return (0, _testHelpers.render)(pilasBlockly());
    ...
    (0, _qunit.test)('Cuando el componente está listo para ser usado',
    /*#__PURE__*/
    function () {
    ...
    (0, _qunit.test)('Mientras se ejecuta un ejercicio',
    /*#__PURE__*/
    function () {
    ...
    (0, _qunit.test)('Cuando se termina de ejecutar un ejercicio',
    /*#__PURE__*/
    function () {
    ...
    (0, _qunit.test)('Al reiniciar desaparece reiniciar y aparece ejecutar',
    /*#__PURE__*/
    function () {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                _context5.next = 5;
                return findElementWithText(this, "button", "Reiniciar").click();
    ...
    function findElementWithText(context, elemento, texto) {
      return Array.from(context.element.querySelectorAll(elemento)).find(function (domElement) {
        return domElement.innerText.includes(texto);
      });
    }
...
define("pilasbloques/tests/integration/components/pilas-botones-zoom-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-canvas-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-cargando-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-desafio-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-editor-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers", "pilasbloques/tests/helpers/mocks"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers, _mocks) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-header-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-libro-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-notificador-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-spinner-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
...
define("pilasbloques/tests/integration/components/pilas-toggle-test", ["@babel/runtime/helpers/esm/asyncToGenerator", "qunit", "ember-qunit", "@ember/test-helpers"], function (_asyncToGenerator2, _qunit, _emberQunit, _testHelpers) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | pilas toggle', function (hooks) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return (0, _testHelpers.render)(toggle);
    ...
    (0, _qunit.test)('it can be disabled',
    /*#__PURE__*/
    function () {
      var _ref3 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
    ...
    (0, _qunit.test)('it can be checked',
    /*#__PURE__*/
    function () {
      var _ref4 = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
    ...
    var toggle = Ember.HTMLBars.template({
      "id": "gO9TBd3N",
...
define("pilasbloques/tests/integration/components/pilasweb-actores-test", ["qunit", "ember-qunit", "@ember/test-helpers", "pilasbloques/tests/helpers/createPilasTest"], function (_qunit, _emberQunit, _testHelpers, _createPilasTest) {
  ...
  (0, _qunit.module)('Integration | Component | pilasweb actores', function (hooks) {
    ...
    (0, _qunit.test)('Puede crear un actor y actualizar algunos atributos', function (assert) {
      return (0, _createPilasTest.default)(this, 'AlienInicial', function (pilas, resolve) {
        /* CREACION DE ACTORES */
        var actor = new pilas.actores.Mono();
...
define("pilasbloques/tests/integration/desafios/AlienTocaBoton-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'AlienTocaBoton';
  (0, _actividadTest.moduloActividad)(nombre, function () {
...
define("pilasbloques/tests/integration/desafios/AlimentandoALosPeces-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = "AlimentandoALosPeces";
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/BlockIDGeneration-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("BlockIDProblematicos", function () {
...
define("pilasbloques/tests/integration/desafios/BlocksGallery-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'Blocks Gallery - aliases test';
  (0, _actividadTest.moduloActividad)(nombre, function () {
...
define("pilasbloques/tests/integration/desafios/DibujandoFiguras-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoAlCuadrado', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoRayuelaRobotica', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoCortoPorLaDiagonal', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoMamushkaCuadrada', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoEscaleraCuadrada', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoHexagono', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoPiramideInvertida', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoFigurasDentroDeFiguras', function () {
    (0, _actividadTest.actividadTest)('DibujandoFigurasDentroDeFiguras', {
  ...
  (0, _actividadTest.moduloActividad)('DibujandoLaCuevaDeEstalagtitas', function () {
  ...
  (0, _actividadTest.moduloActividad)('DibujoLibre', function () {
...
define("pilasbloques/tests/integration/desafios/ElCangrejoAguafiestas-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = "ElCangrejoAguafiestas";
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/ElDetectiveChaparro-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = "ElDetectiveChaparro";
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/ElMarcianoEnElDesierto-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = "ElMarcianoEnElDesierto";
  (0, _actividadTest.moduloActividad)(nombre, function () {
...
define("pilasbloques/tests/integration/desafios/ElMonoCuentaDeNuevo-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = "ElMonoCuentaDeNuevo";
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/ElMonoQueSabeContar-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'ElMonoQueSabeContar';
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/ElRecolectorDeEstrellas-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'ElRecolectorDeEstrellas';
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/LaGranAventuraDelMarEncantado-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'LaGranAventuraDelMarEncantado';
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/PrendiendoLasCompus-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'PrendiendoLasCompus';
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/PrendiendoLasCompusParametrizado-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'PrendiendoLasCompusParametrizado';
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/PrendiendoLasFogatas-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  var nombre = 'PrendiendoLasFogatas';
  (0, _actividadTest.moduloActividad)(nombre, function () {
    (0, _actividadTest.actividadTest)(nombre, {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/Coty-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Coty", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/Duba-AlternativaCondicional-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Duba - Alternativa condicional", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/Duba-PrimerosProgramas-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Duba - Primeros programas", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/Duba-Repeticion-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Duba - Repetición", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/Lita-AlternativaCondicional-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Lita - Alternativa condicional", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/Lita-PrimerosProgramas-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Lita - Primeros programas", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/Lita-Repeticion-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Lita - Repetición", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/TotoEscritor-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Toto escritor", function () {
...
define("pilasbloques/tests/integration/desafios/libroPrimaria/TotoLector-test", ["pilasbloques/tests/helpers/actividadTest"], function (_actividadTest) {
  ...
  (0, _actividadTest.moduloActividad)("Toto lector", function () {
...
define("pilasbloques/tests/integration/ejerciciosPilas/Casilla-test", ["qunit", "pilasbloques/tests/helpers/ejerciciosPilasTest", "pilasbloques/tests/helpers/createPilasTest"], function (_qunit, _ejerciciosPilasTest, _createPilasTest) {
  ...
  var nombre = 'Casilla';
  (0, _ejerciciosPilasTest.moduloEjerciciosPilas)(nombre, function () {
    (0, _qunit.test)('propiedades', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var Cuadricula = pilasService.evaluar("Cuadricula");
...
define("pilasbloques/tests/integration/ejerciciosPilas/Cuadricula-test", ["qunit", "pilasbloques/tests/helpers/ejerciciosPilasTest", "pilasbloques/tests/helpers/createPilasTest"], function (_qunit, _ejerciciosPilasTest, _createPilasTest) {
  ...
  (0, _ejerciciosPilasTest.moduloEjerciciosPilas)(nombre, function () {
    ...
    function prepararEscena(pilas, pilasService) {
      var escena = {};
      var Cuadricula = pilasService.evaluar("Cuadricula");
      var AlienAnimado = pilasService.evaluar("AlienAnimado");
    ...
    (0, _qunit.test)('Set Ancho', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var escena = prepararEscena(pilas, pilasService);
    ...
    (0, _qunit.test)('Mover a la casilla derecha', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var escena = prepararEscena(pilas, pilasService);
        var MoverACasillaDerecha = pilasService.evaluar("MoverACasillaDerecha");
        escena.cuadricula.agregarActor(escena.actor1, 0, 0);
    ...
    (0, _qunit.test)('Mover a la casilla izquierda', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var escena = prepararEscena(pilas, pilasService);
        var MoverACasillaIzquierda = pilasService.evaluar("MoverACasillaIzquierda");
    ...
    (0, _qunit.test)('Mover a casilla abajo', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var escena = prepararEscena(pilas, pilasService);
        var MoverACasillaAbajo = pilasService.evaluar("MoverACasillaAbajo");
    ...
    (0, _qunit.test)('Mover a casilla arriba', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var escena = prepararEscena(pilas, pilasService);
        var MoverACasillaArriba = pilasService.evaluar("MoverACasillaArriba");
        escena.cuadricula.agregarActor(escena.actor1, 1, 0);
        var x = escena.actor1.x;
        var y = escena.actor1.y;
...
define("pilasbloques/tests/integration/ejerciciosPilas/CuadriculaEsparsa-test", ["qunit", "pilasbloques/tests/helpers/ejerciciosPilasTest", "pilasbloques/tests/helpers/createPilasTest"], function (_qunit, _ejerciciosPilasTest, _createPilasTest) {
  ...
  var nombre = 'Cuadricula Esparsa';
  (0, _ejerciciosPilasTest.moduloEjerciciosPilas)(nombre, function () {
    (0, _qunit.test)('Constructor', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var CuadriculaEsparsa = pilasService.evaluar("CuadriculaEsparsa");
        var matriz = [['T', 'T', 'T', 'T', 'T', 'T'], ['T', 'F', 'F', 'F', 'F', 'T'], ['T', 'T', 'T', 'T', 'T', 'T'], ['T', 'F', 'F', 'F', 'F', 'T'], ['T', 'T', 'T', 'T', 'T', 'T']];
        var cuadricula = new CuadriculaEsparsa(0, 0, {
          alto: 100
        }, {
          grilla: 'invisible.png',
          cantColumnas: 1
    ...
    (0, _qunit.test)('Direcciones', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        ...
        var casilla = cuadricula.casilla(0, 0);
...
define("pilasbloques/tests/integration/ejerciciosPilas/Estado-test", ["qunit", "pilasbloques/tests/helpers/ejerciciosPilasTest", "pilasbloques/tests/helpers/createPilasTest"], function (_qunit, _ejerciciosPilasTest, _createPilasTest) {
  ...
  (0, _ejerciciosPilasTest.moduloEjerciciosPilas)(nombre, function () {
    (0, _qunit.test)('Agregar Transicion', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var Estado = pilasService.evaluar("Estado");
        var EstadoConTransicion = pilasService.evaluar("EstadoConTransicion");
        var e2 = new Estado('id2');
        var e = new EstadoConTransicion(pilas.escena_actual(), 'id');
...
define("pilasbloques/tests/integration/ejerciciosPilas/ImagenesPreCarga-test", ["qunit", "pilasbloques/tests/helpers/ejerciciosPilasTest", "pilasbloques/tests/helpers/createPilasTest"], function (_qunit, _ejerciciosPilasTest, _createPilasTest) {
  ...
  (0, _ejerciciosPilasTest.moduloEjerciciosPilas)('Imagenes Pre-carga', function () {
    function testDePrecarga(escena, constructor, imagenesEsperadas) {
      (0, _qunit.test)(escena, function (assert) {
        return (0, _createPilasTest.default)(this, constructor, function (pilas, resolve, pilasService) {
          var imagenes = pilasService.imagenesParaPrecargar(constructor);
...
define("pilasbloques/tests/integration/ejerciciosPilas/Interactuar-test", ["qunit", "pilasbloques/tests/helpers/ejerciciosPilasTest", "pilasbloques/tests/helpers/createPilasTest", "sinon"], function (_qunit, _ejerciciosPilasTest, _createPilasTest, _sinon) {
  ...
  var nombre = 'Interactuar';
  var argumentosParaApretar = {
  ...
  function setup(pilasService) {
    var Interactuar = pilasService.evaluar("Interactuar");
    var alien = new (pilasService.evaluar("AlienAnimado"))(0, 0);
    pilasService.evaluar("pilas").escena_actual().automata = alien;
    var boton = new (pilasService.evaluar("BotonAnimado"))(0, 0);
    var cuadricula = new (pilasService.evaluar("Cuadricula"))(0, 0, 1, 2, {}, {
      grilla: 'invisible.png'
    });
    return {
  ...
  function interactuarAlienThrows(argumentos, mensajeError, pilasService, assert, alien) {
    ...
    var elInteractuar = new (pilasService.evaluar("Interactuar"))(argumentos);
    elInteractuar.iniciar(alien);
    assert.throws(function () {
      return elInteractuar.configuracionInicial();
  ...
  (0, _ejerciciosPilasTest.moduloEjerciciosPilas)(nombre, function () {
    (0, _qunit.test)('Sanitización: Interactuar sanitiza correctamente argumentos correctos', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var Interactuar = pilasService.evaluar("Interactuar");
        var instance = new Interactuar(argumentosParaApretar);
    ...
    (0, _qunit.test)('Sanitización: No se puede crear una instancia de Interactuar, falta la etiqueta', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var ArgumentError = pilasService.evaluar("ArgumentError");
        var Interactuar = pilasService.evaluar("Interactuar");
        assert.throws(function () {
          return new Interactuar({}).sanitizarArgumentos();
    ...
    (0, _qunit.test)('Con cuadrícula: No se puede interactuar con un objeto si estoy en otra casilla', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var _setup2 = setup(pilasService),
            alien = _setup2.alien,
            boton = _setup2.boton,
            cuadricula = _setup2.cuadricula;
    ...
    (0, _qunit.test)('Sin cuadrícula: Interactúa cuando está el objeto. AnimacionInteractuadoFinal funciona correctamente', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var _setup3 = setup(pilasService),
            Interactuar = _setup3.Interactuar,
            alien = _setup3.alien,
            boton = _setup3.boton;

        (0, _ejerciciosPilasTest.hacerLuegoConCallback)(alien, Interactuar, argumentosParaApretar, function () {
    ...
    (0, _qunit.test)('Con cuadrícula: Interactúa cuando está el objeto', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var _setup4 = setup(pilasService),
            Interactuar = _setup4.Interactuar,
            alien = _setup4.alien,
            boton = _setup4.boton,
            cuadricula = _setup4.cuadricula;
    ...
    (0, _qunit.test)('mensajeError funciona correctamente', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var _setup5 = setup(pilasService),
            alien = _setup5.alien;

        var argumentosMensajeError = {
    ...
    (0, _qunit.test)("animacionInteractuadoMientras funciona correctamente", function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var _setup6 = setup(pilasService),
            Interactuar = _setup6.Interactuar,
            alien = _setup6.alien;
        ...
        var elInteractuar = new Interactuar(argumentos);

        var spy = _sinon.default.spy(alien, 'cargarAnimacion');

        _sinon.default.stub(Interactuar.prototype, 'interactuado').callsFake(function () {
          return alien;
        });
    ...
    (0, _qunit.test)('comportamientoAdicional funciona correctamente', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var _setup7 = setup(pilasService),
            Interactuar = _setup7.Interactuar,
            alien = _setup7.alien,
            boton = _setup7.boton;
        ...
        var spy = _sinon.default.spy(boton, 'hacer_luego');

        (0, _ejerciciosPilasTest.hacerLuegoConCallback)(alien, Interactuar, argumentos, function () {
          assert.ok(spy.calledOnce);
          spy.restore();
          resolve();
        });
...
define("pilasbloques/tests/integration/ejerciciosPilas/StatePattern-test", ["qunit", "pilasbloques/tests/helpers/ejerciciosPilasTest", "pilasbloques/tests/helpers/createPilasTest"], function (_qunit, _ejerciciosPilasTest, _createPilasTest) {
  ...
  var nombre = 'State Pattern';
  (0, _ejerciciosPilasTest.moduloEjerciciosPilas)(nombre, function () {
    (0, _qunit.test)('Agregar Estado', function (assert) {
      return (0, _createPilasTest.default)(this, 'EscenaTests', function (pilas, resolve, pilasService) {
        var BuilderStatePattern = pilasService.evaluar("BuilderStatePattern");
        var builder = new BuilderStatePattern(pilas.escena_actual(), 'inicial');
  ...
  (0, _qunit.module)('Unit | Components | pilas-blockly', function (hooks) {
    ...
    (0, _qunit.test)('Ejecutar paso a paso bloquea la ejecución', function (assert) {
      ...
      Ember.run.later(function () {
        ...
        assert.ok(_this.ctrl.get('pausadoEnBreakpoint'));
      });
    });
    (0, _qunit.test)('Step desbloquea el breakpoint', function (assert) {
      ...
      this.ctrl.send('ejecutar', true);
      Ember.run.later(function () {
        assert.ok(_this2.ctrl.get('pausadoEnBreakpoint'));

        _this2.ctrl.send('step');

        assert.notOk(_this2.ctrl.get('pausadoEnBreakpoint'));
      });
    });
    (0, _qunit.test)('Luego de ejecutar termina de ejecutar', function (assert) {
      ...
      this.ctrl.send('ejecutar');
      Ember.run.later(function () {
        assert.notOk(_this3.ctrl.get('ejecutando'));
        assert.ok(_this3.ctrl.get('terminoDeEjecutar'));
      });
    });
    (0, _qunit.test)('Al resolver el problema muestra el fin del desafío', function (assert) {
      ...
      this.ctrl.send('ejecutar');
      Ember.run.later(function () {
        assert.ok(_this4.ctrl.get('mostrarDialogoFinDesafio'));
      });
    });
    ...
    var emptyProcedureWithParam = "\n  <block type=\"procedures_defnoreturn\">\n    <mutation>\n      <arg name=\"par\xE1metro 1\"></arg>\n    </mutation>\n    <field name=\"NAME\">Hacer algo</field>\n    <field name=\"ARG0\">par\xE1metro 1</field>\n    <statement name=\"STACK\">\n      <shadow type=\"required_statement\"></shadow>\n    </statement>\n  </block>\n  ";
    var nonFilledProcedure = "    \n  <block type=\"procedures_defnoreturn\">\n    <field name=\"NAME\">Hacer algo</field>\n    <statement name=\"STACK\">\n      <block type=\"GirarGrados\">\n        <value name=\"grados\">\n          <shadow type=\"required_value\"></shadow>\n        </value>\n      </block>\n    </statement>\n  </block>\n  ";
    (0, _qunit.test)('Ejecuta aún cuando existe procedimiento vacío', function (assert) {
      Blockly.textToBlock(emptyProcedure);
      this.ctrl.send('ejecutar');
      assert.ok(_mocks.interpreteMock.run.called);
    });
    (0, _qunit.test)('Ejecuta aún cuando existe procedimiento vacío con parámetros', function (assert) {
      Blockly.textToBlock(emptyProcedureWithParam);
      this.ctrl.send('ejecutar');
      assert.ok(_mocks.interpreteMock.run.called);
    });
    (0, _qunit.test)('No ejecuta cuando existe procedimiento con algún agujero', function (assert) {
      Blockly.textToBlock(nonFilledProcedure);
      this.ctrl.send('ejecutar');
      assert.notOk(_mocks.interpreteMock.run.called);
    });
    (0, _qunit.test)('Al ejecutar aparecen los warnings de bloques vacíos', function (assert) {
      var program = Blockly.textToBlock(nonFilledProgram);
      var required = (0, _utils.findBlockByTypeIn)(program, "required_statement");
      (0, _utils.assertNotWarning)(assert, required);
      this.ctrl.send('ejecutar');
      Ember.run.later(function () {
        return (0, _utils.assertWarning)(assert, required, "¡Acá faltan bloques comandos!");
      });
    });
  });
});
...
define("pilasbloques/tests/unit/components/pilas-solution-file-test", ["qunit", "ember-qunit", "pilasbloques/tests/helpers/mocks", "sinon"], function (_qunit, _emberQunit, _mocks, _sinon) {
  ...
  var ctrl;
  var version;
  var actividad = _mocks.actividadMock.nombre;
  var solucion = "";
  (0, _qunit.module)('Unit | Components | pilas-solution-file', function (hooks) {
    ...
    (0, _qunit.test)("Al guardar solución crea el archivo correctamente", function (assert) {
      ...
      var archivo = "".concat(actividad, ".spbq");
    ...
    var solucionCompletaConVersionAnteriorParaOtraActividad = {
      version: -1,
      actividad: "Otra_Actividad",
      solucion: solucion
    };
    ...
    function goodFileTest(mensaje, contenido) {
      fileTest(mensaje, contenido, function (assert) {
        assert.ok(ctrl.get("workspace"));
      }, function () {});
    }

    function failFileTest(mensaje, contenido, cb) {
      fileTest(mensaje, contenido, function () {}, cb);
    }

    function fileTest(mensaje, contenido, cbGood, cbFail) {
      (0, _qunit.test)(mensaje, function (assert) {
        var done = assert.async();
        var archivo = new Blob([JSON.stringify(contenido)]);
        ctrl.leerSolucionWeb(archivo).then(function () {
          cbGood(assert);
          done();
        }).catch(function (err) {
          cbFail(assert, err);
...
define("pilasbloques/tests/unit/controllers/acercade-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Controller | acercade', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      var controller = this.owner.lookup('controller:acercade');
  ...
  (0, _qunit.module)('Unit | Model | desafio', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      ...
      var model = Ember.run(function () {
        return _this.owner.lookup('service:store').createRecord('desafio');
...
define("pilasbloques/tests/unit/models/libro-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Model | libro', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      ...
      var model = Ember.run(function () {
        return _this.owner.lookup('service:store').createRecord('libro');
      }); // let store = this.store();
...
define("pilasbloques/tests/unit/routes/acercade-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Route | acercade', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
      var route = this.owner.lookup('route:acercade');
      assert.ok(route);
    });
  });
});
define("pilasbloques/tests/unit/routes/desafio-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Route | desafio', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
      var route = this.owner.lookup('route:desafio');
      assert.ok(route);
    });
  });
});
...
define("pilasbloques/tests/unit/services/available-blocks-validator-test", ["ember-qunit", "pilasbloques/tests/helpers/mocks", "pilasbloques/tests/helpers/utils"], function (_emberQunit, _mocks, _utils) {
  ...
  (0, _emberQunit.test)('Should not disable global available blocks', function (assert) {
    var program = Blockly.textToBlock(simpleProgram);
  ...
  (0, _emberQunit.test)('Should disable not available activity blocks', function (assert) {
    var program = Blockly.textToBlock(simpleProgram);
    var moveLeft = (0, _utils.findBlockByTypeIn)(program, "MoverACasillaIzquierda");
  ...
  (0, _emberQunit.test)('Should not disable available activity blocks', function (assert) {
    var program = Blockly.textToBlock(simpleProgram);
    var moveRight = (0, _utils.findBlockByTypeIn)(program, "MoverACasillaDerecha");
    validator.disableNotAvailableBlocksInWorkspace(["MoverACasillaDerecha"]);
  ...
  var procedureCallProgram = "\n<block type=\"al_empezar_a_ejecutar\" deletable=\"false\" movable=\"false\" editable=\"false\" x=\"0\" y=\"0\">\n<statement name=\"program\">\n  <block type=\"procedures_callnoreturn\">\n    <mutation name=\"Hacer algo\"></mutation>\n  </block>\n</statement>\n</block>\n";
  (0, _emberQunit.test)('Should disable procedure blocks when they are not available', function (assert) {
    var procedure = Blockly.textToBlock(procedureDefinition);
    var variable = (0, _utils.findBlockByTypeIn)(procedure, "variables_get");
    var program = Blockly.textToBlock(procedureCallProgram);
    var procedureCall = (0, _utils.findBlockByTypeIn)(program, "procedures_callnoreturn");
  ...
  var mathArithmeticProgram = "\n<block type=\"al_empezar_a_ejecutar\" deletable=\"false\" movable=\"false\" editable=\"false\" x=\"15\" y=\"15\">\n<statement name=\"program\">\n  <block type=\"GirarGrados\">\n    <value name=\"grados\">\n      <block type=\"math_arithmetic\">\n        <field name=\"OP\">ADD</field>\n        <value name=\"A\">\n          <block type=\"math_number\">\n            <field name=\"NUM\">90</field>\n          </block>\n        </value>\n        <value name=\"B\">\n          <block type=\"math_number\">\n            <field name=\"NUM\">90</field>\n          </block>\n        </value>\n      </block>\n    </value>\n  </block>\n</statement>\n</block>\n";
  (0, _emberQunit.test)('Should works for original blocks with alias', function (assert) {
    var program = Blockly.textToBlock(mathArithmeticProgram);
    var mathArithmetic = (0, _utils.findBlockByTypeIn)(program, "math_arithmetic");
...
define("pilasbloques/tests/unit/services/blocks-gallery-test", ["qunit", "ember-qunit", "pilasbloques/tests/helpers/mocks", "pilasbloques/tests/helpers/utils"], function (_qunit, _emberQunit, _mocks, _utils) {
  ...
  (0, _qunit.module)('Unit | Service | blocks-gallery', function (hooks) {
    ...
    function testHasRequiredInputs(blockType) {
      ...
      (0, _qunit.test)("".concat(blockType, " ").concat(required ? "has" : "doesn't have", " required inputs"), function (assert) {
        var block = (0, _utils.createBlock)(blockType);
    ...
    (0, _qunit.test)('procedures_callnoreturn has required inputs', function (assert) {
      var block = Blockly.textToBlock(precedureCall);
    ...
    (0, _qunit.test)('When required input exists should be ok', function (assert) {
      var block = Blockly.textToBlock(toolbox);
    ...
    (0, _qunit.test)('Parameter in non parent procedure should be disabled and with warning', function (assert) {
      Blockly.textToBlock(emptyProcedure);
      var param = findParam(Blockly.textToBlock(main));
    ...
    (0, _qunit.test)('Parameter in non parent procedure should only be disabled', function (assert) {
      Blockly.textToBlock(emptyProcedure);
      var param = findParam(Blockly.textToBlock(flying));
      (0, _utils.assertDisabled)(assert, param);
      (0, _utils.assertNotWarning)(assert, param);
    });
    (0, _qunit.test)('Parameter should dispose when procedure is disposed', function (assert) {
      var procedure = Blockly.textToBlock(emptyProcedure);
      var param = findParam(Blockly.textToBlock(flying));
    ...
    var testAlias = function testAlias(alias, type) {
...
define("pilasbloques/tests/unit/services/highlighter-test", ["qunit", "ember-qunit", "pilasbloques/tests/helpers/mocks"], function (_qunit, _emberQunit, _mocks) {
  ...
  (0, _qunit.module)('Unit | Service | highlighter', function (hooks) {
    ...
    function loadProgramAndSendSteps(steps, blocksAsText) {
      ...
      var definitionBlocks = blocksAsText.map(Blockly.textToBlock);
      var ignoredBlockTypes = ["math_number", "HayTomate"]; // Esta ejecución solamente RECORRE los bloques. ¡No tiene en cuenta la lógica!
    ...
    function assertTypes(assert, blocks, expectedTypes) {
      assert.deepEqual(blocks.map(function (it) {
        return it.type;
      }), expectedTypes);
...
define("pilasbloques/tests/unit/services/notificador-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Service | notificador', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      var service = this.owner.lookup('service:notificador');
      assert.ok(service);
...
define("pilasbloques/tests/unit/services/pilas-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Service | pilas', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      var service = this.owner.lookup('service:pilas');
      assert.ok(service);
    });
  });
});
define("pilasbloques/tests/unit/services/zoom-test", ["qunit", "ember-qunit"], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Service | zoom', function (hooks) {
    ...
    (0, _qunit.test)('it exists', function (assert) {
      var service = this.owner.lookup('service:zoom');
      assert.ok(service);
    });
  });
});
